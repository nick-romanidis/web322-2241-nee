...
app.get("/", (req, res) => {
    nameModel.find()
        ...
        .catch(() => {
            console.log("Couldn't get list of names");
            res.redirect("/");
        });
});
...
app.post("/updateName", (req, res) => {
    ...
    if (fName.trim().length === 0 && lName.trim().length === 0) {
        ...
        nameModel.deleteOne({
            ...
            .catch(err => {
                console.log("Couldn't delete the name document for: " + nickname + "\n" + err);
                res.redirect("/");
            });
    }
    else {
        ...
        nameModel.updateOne({
            ...
            .catch(err => {
                console.log("Couldn't update the name document for: " + nickname + "\n" + err);
                res.redirect("/");
            });
